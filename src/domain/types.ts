...
export const THEMES=['touchflow-blue','electric-navy','petrol-coral','violet-lavender','carbon-orange','burgundy-rose','night-cyan','turquoise-mango','indigo-fuchsia','cobalt-lime','plum-coral','cyan-violet','raspberry-peach','midnight-yellow','teal-bubblegum'] as const;
